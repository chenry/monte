 ...
 * 
 * <p>FIXME - Separation between AbstractQuickTimeStream and QuickTimeOutputStream 
 * is not clean. Move write methods in the track classes down to QuickTimeOutputStream.</p>
 *
...
public class AbstractQuickTimeStream {
     ...
     * /
    public static enum QuickTimeVideoFormat {
    ...
    ANIMATION("rle ", "Animation", false),;
    //
    protected String compressionType;
    protected String compressorName;
    protected boolean allSamplesAreSyncSamples;
    
    QuickTimeVideoFormat(String compressionType, String compressorName, boolean allSamplesAreSyncSamples) {
    ...
    protected class DataAtom extends Atom {
         ...
         * ImageOutputStream.
         * @param name The type name of the atom.
         */
