 ...
 * @version $Id: QuickTimePCMAudioCodec.java 134 2011-12-02 16:23:00Z werner $
 */
    ...
    public QuickTimePCMAudioCodec() {
        super(new Format[]{
                    new Format(MediaTypeKey,MediaType.AUDIO,EncodingKey,ENCODING_PCM_SIGNED,
                            SignedKey,true),//
                    new Format(MediaTypeKey,MediaType.AUDIO,EncodingKey,ENCODING_PCM_UNSIGNED,
                            SignedKey,false),//
                    //
                    // 8-bit unsigned has "raw " encoding regardless of endian
                    new Format(MediaTypeKey,MediaType.AUDIO,EncodingKey,ENCODING_QUICKTIME_RAW_PCM,
                            SignedKey,false,SampleSizeInBitsKey,8),//
                    //
                    // 8-bit signed has "sowt" encoding for little endian
                    new Format(MediaTypeKey,MediaType.AUDIO,EncodingKey,ENCODING_QUICKTIME_SOWT_PCM,
                    ...
                    new Format(MediaTypeKey,MediaType.AUDIO,EncodingKey,ENCODING_QUICKTIME_TWOS_PCM,
                            ...
                            SampleSizeInBitsKey,16),//
                    //
                    new Format(MediaTypeKey,MediaType.AUDIO,EncodingKey,ENCODING_QUICKTIME_IN24_PCM,
                            ByteOrderKey,ByteOrder.BIG_ENDIAN,
                            SignedKey,true,SampleSizeInBitsKey,24),//
                    new Format(MediaTypeKey,MediaType.AUDIO,EncodingKey,ENCODING_QUICKTIME_IN32_PCM,
                            ByteOrderKey,ByteOrder.BIG_ENDIAN,
                ...
                new Format[]{
                    ...
                    new Format(MediaTypeKey,MediaType.AUDIO,EncodingKey,ENCODING_QUICKTIME_RAW_PCM,
                            SignedKey,false,SampleSizeInBitsKey,8),//
                    //
                    // 8-bit signed has "sowt" encoding if little endian
                    new Format(MediaTypeKey,MediaType.AUDIO,EncodingKey,ENCODING_QUICKTIME_SOWT_PCM,
                            ByteOrderKey,ByteOrder.LITTLE_ENDIAN,
                            SignedKey,true,SampleSizeInBitsKey,8),//
                    //
                    // 8-bit signed has "twos" encoding if big endian
                    new Format(MediaTypeKey,MediaType.AUDIO,EncodingKey,ENCODING_QUICKTIME_TWOS_PCM,
                            ByteOrderKey,ByteOrder.BIG_ENDIAN,
                            SignedKey,true,SampleSizeInBitsKey,8),//
