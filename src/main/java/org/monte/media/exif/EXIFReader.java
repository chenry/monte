 ...
 * @version $Id: EXIFReader.java 138 2011-12-28 09:21:00Z werner $
 */
public class EXIFReader {

    private File file;
    private ImageInputStream iin;
    /** When this is set to true, the reader stops after heaving read 
     * the metadata of the first image. 
     */
    private boolean firstImageOnly;
    /** Whether data from the file container shall be added to the Exif data.
     * For most file types, this adds the width and height of the image to
     * the Exif.
     */
     ...
     * <p>
     * Format description replicated from 
     * <a href="http://download.java.net/media/jai-imageio/javadoc/1.1/com/sun/media/imageio/plugins/tiff/package-summary.html"
