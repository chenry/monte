 ...
 * @version $Id: AbstractAVIStream.java 137 2011-12-28 09:19:37Z werner $
 */
public abstract class AbstractAVIStream {
    ...
    protected class VideoTrack extends Track {
        ...
        public VideoTrack(int trackIndex, String fourCC, Format videoFormat) {
            ...
            sampleChunkFourCC = videoFormat != null && videoFormat.get(EncodingKey).equals(ENCODING_AVI_DIB) ? twoCC + "db" : twoCC + "dc";
        }
    ...
    protected class AudioTrack extends Track {
        ...
        public AudioTrack(int trackIndex, String fourCC) {
            super(trackIndex, AVIMediaType.AUDIO, fourCC);
            sampleChunkFourCC = twoCC + "wb";
    ...
    protected class CompositeChunk extends Chunk {
        ...
        public void finish() throws IOException {
            if (!finished) {
                ...
                out.writeInt(typeToInt(compositeType));
                out.writeInt((int) (size() - 8));
                out.writeInt(typeToInt(chunkType));
    ...
    protected class DataChunk extends Chunk {
        ...
        protected ImageOutputStream data;
        protected boolean finished;
         ...
         */
        public DataChunk(String name, long dataSize) throws IOException {
            super(name);
    ...
    protected class MidiTrack extends Track {
        ...
        private final String sampleChunkFourCC;

        public MidiTrack(int trackIndex, String fourCC) {
    ...
    protected class TextTrack extends Track {
        ...
        public TextTrack(int trackIndex, String fourCC) {
